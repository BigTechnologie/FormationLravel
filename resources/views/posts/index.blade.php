...
<div class="d-flex justify-content-end">
    ...
    <a href="{{ route('admin.post.create') }}" class="btn btn-success m-1">
...
<div class="">
    ...
    <div class="form-check form-switch">
        <input name="isPublished" id="isPublished" data-id="{{$post->id}}" value="true" data-bs-toggle="toggle"  {{ isset($post) && $post->isPublished == 'true' ? 'checked' : '' }} class="form-check-input" type="checkbox" role="switch" />
    </div>
</td>
						<td>
                    <a href="{{ route('admin.post.show', ['id' => $post->id]) }}" class="btn btn-primary btn-sm">
                        <i class="fa-solid fa-eye"></i>
                    </a>
                    <a href="{{ route('admin.post.edit', ['id' => $post->id]) }}" class="btn btn-success btn-sm">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                    <a href="#" data-id="{{ $post->id }}" class="btn btn-danger btn-sm deleteBtn">
