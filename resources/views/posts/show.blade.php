    ...
    <tr>
        ...
        <td>
            <div class="form-check form-switch">
                <input name="isPublished" disabled id="isPublished" value="true" data-bs-toggle="toggle"  {{ $post->isPublished == 'true' ? 'checked' : '' }} class="form-check-input" type="checkbox" role="switch" />
            </div>
        </td>
    </tr>
