...
<div class="d-flex justify-content-end">
    ...
    <a href="<?php echo e(route('admin.user.create')); ?>" class="btn btn-success m-1">
        ...
        <table  id="User" class="table">
            ...
            <tbody>
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						...
						<td>
                    <a href="<?php echo e(route('admin.user.show', ['id' => $user->id])); ?>" class="btn btn-primary btn-sm">
                        <i class="fa-solid fa-eye"></i>
                    </a>
                    <a href="<?php echo e(route('admin.user.edit', ['id' => $user->id])); ?>" class="btn btn-success btn-sm">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                    <a href="#" data-id="<?php echo e($user->id); ?>" class="btn btn-danger btn-sm deleteBtn">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin Stagiaire\Desktop\FORMATIONS\Formation_Laravel\FormationLravel\resources\views/users/index.blade.php ENDPATH**/ ?>