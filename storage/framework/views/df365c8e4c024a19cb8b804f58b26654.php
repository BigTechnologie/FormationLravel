    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px; width:100%; background:#ffffff; border-radius:10px; overflow:hidden;"> 
        <tr>
            <td style="padding:30px;">
                ...
                <p style="font-size: 16px; line-height:1.6; white-space:pre-line; margin:0;"><?php echo e($messageContent); ?></p>
            </td>
        </tr>
        <?php if(!empty($logoPath) && file_exists($logoPath)): ?>
            <tr>
                <td align="center" style="padding: 22px 30px; border-top:1px solid #e5e7eb; background:#fafafa">
                    <p>Envoyé par</p>
                    <img src="<?php echo e($message->embed($logoPath)); ?>" alt="Logo de l'entreprise" width="140" style="display: block; width:140px; max-width:100%; height:auto; border:0;">
                </td>
            </tr>
        <?php endif; ?>
    </table>
</body>
</html><?php /**PATH C:\Users\Admin Stagiaire\Desktop\FORMATIONS\Formation_Laravel\FormationLravel\resources\views/emails/test.blade.php ENDPATH**/ ?>