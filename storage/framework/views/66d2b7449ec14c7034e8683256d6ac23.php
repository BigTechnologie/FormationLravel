...
<div class="d-flex justify-content-end">
    ...
    <a href="<?php echo e(route('admin.post.create')); ?>" class="btn btn-success m-1">
...
<div class="">
    ...
    <div class="form-check form-switch">
        <input name="isPublished" id="isPublished" data-id="<?php echo e($post->id); ?>" value="true" data-bs-toggle="toggle"  <?php echo e(isset($post) && $post->isPublished == 'true' ? 'checked' : ''); ?> class="form-check-input" type="checkbox" role="switch" />
    </div>
</td>
						<td>
                    <a href="<?php echo e(route('admin.post.show', ['id' => $post->id])); ?>" class="btn btn-primary btn-sm">
                        <i class="fa-solid fa-eye"></i>
                    </a>
                    <a href="<?php echo e(route('admin.post.edit', ['id' => $post->id])); ?>" class="btn btn-success btn-sm">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                    <a href="#" data-id="<?php echo e($post->id); ?>" class="btn btn-danger btn-sm deleteBtn">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        checkbox.onchange = async (event) => {
            ...
            const response = await fetch('/admin/posts/speed/' + id, {
                method: 'PUT',
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const tableHeaders = document.querySelectorAll('#Post th');
            ...
            tableHeaders.forEach(function(header, index) {
                ...
                const savedSelection = localStorage.getItem('selectedColumns#Post');
        ...
        function toggleColumn(columnIndex, show) {
            const dataTable = document.getElementById('Post');
        ...
        function saveSelection() {
            ...
            localStorage.setItem('selectedColumns#Post', JSON.stringify(selectedColumns));
        }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin Stagiaire\Desktop\FORMATIONS\Formation_Laravel\FormationLravel\resources\views/posts/index.blade.php ENDPATH**/ ?>